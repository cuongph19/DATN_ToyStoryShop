...
//
//    public Sale_Adapter(Context context, List<Product_Model> productModelList) {
...
//    }
//
//    public Sale_Adapter(Context context, List<Product_Model> productModelList, boolean isInHomeFragment, String documentId) {
//        this.context = context;
...
//    @NonNull
//    @Override
//    public Sale_Adapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View itemView = LayoutInflater.from(context).inflate(R.layout.item_sale_product, parent, false);
//        return new Sale_Adapter.ProductViewHolder(itemView);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull Sale_Adapter.ProductViewHolder holder, int position) {
...
//
//    @Override
//    public void onViewRecycled(@NonNull Sale_Adapter    .ProductViewHolder holder) {

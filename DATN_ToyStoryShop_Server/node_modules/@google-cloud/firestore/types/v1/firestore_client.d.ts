...
export declare class FirestoreClient {
   ...
   * @param {string} [options.email] - Account email addressModel. Required when
  ...
  /**
   * The DNS addressModel for this API service.
   * @deprecated Use the apiEndpoint method of the client instance.
   * @returns {string} The DNS addressModel for this service.
   */
  static get servicePath(): string;
  /**
   * The DNS addressModel for this API service - same as servicePath.
   * @deprecated Use the apiEndpoint method of the client instance.
   * @returns {string} The DNS addressModel for this service.
   */

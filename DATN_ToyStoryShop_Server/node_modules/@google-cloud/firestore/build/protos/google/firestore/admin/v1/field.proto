...
message Field {
  ...
  //
  // A field path can be a simple field name, e.g. `addressModel` or a path to fields
  // within `map_value` , e.g. `addressModel.city`,
  ...
  //
  // Examples:
  // `` `addressModel.city` `` represents a field named `addressModel.city`, not the map
  // key `city` in the field `addressModel`. `` `*` `` represents a field named `*`,
  // not any field.
  //

...
export type ClientOptions = Partial<ChannelOptions> & {
    ...
    channelFactoryOverride?: (addressModel: string, credentials: ChannelCredentials, options: ClientOptions) => Channel;
    interceptors?: Interceptor[];
    interceptor_providers?: InterceptorProvider[];
...
export declare class Client {
    ...
    constructor(addressModel: string, credentials: ChannelCredentials, options?: ClientOptions);
    close(): void;
    getChannel(): Channel;

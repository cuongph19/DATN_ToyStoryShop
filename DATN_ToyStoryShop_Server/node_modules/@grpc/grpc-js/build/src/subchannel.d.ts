...
export declare class Subchannel {
    ...
    private refcount;
    /**
     * A string representation of the subchannel addressModel, for logging/tracing
     */
     ...
     * @param subchannelAddress The addressModel for the backend that this subchannel
     *     will connect to

...
import { Endpoint } from './subchannel-addressModel';
...
export interface ResolverListener {
     ...
     * @param addressModelList The new list of backend addressModels
     * @param serviceConfig The new service configuration corresponding to the
     *     `addressModelList`. Will be `null` if no service configuration was
     ...
     */
    onSuccessfulResolution(addressModelList: Endpoint[], serviceConfig: ServiceConfig | null, serviceConfigError: StatusObject | null, configSelector: ConfigSelector | null, attributes: {
        [key: string]: unknown;
    }): void;
    /**

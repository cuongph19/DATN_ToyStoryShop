...
// subchannel, such as creation, addressModel resolution, subchannel creation, etc.
...
message Socket {
  ...
  SocketData data = 2;
  // The locally bound addressModel.
  Address local = 3;
  // The remote bound addressModel.  May be absent.
  Address remote = 4;
...
// Address represents the addressModel used to create the socket.
message Address {
  message TcpIpAddress {
    // Either the IPv4 or IPv6 addressModel in bytes.  Will be either 4 bytes or 16
    // bytes in length.
    bytes ip_address = 1;
    // 0-64k, or -1 if not appropriate.
    int32 port = 2;
  }
  // A Unix Domain Socket addressModel.
  message UdsAddress {
    string filename = 1;
  }
  // An addressModel type not included above.
  message OtherAddress {
    // The human readable version of the value.  This value should be set.
    string name = 1;
    // The actual addressModel message.

...
import { Endpoint, SubchannelAddress } from './subchannel-addressModel';
...
export interface ChannelControlHelper {
  /**
   * Returns a subchannel connected to the specified addressModel.
   * @param subchannelAddress The addressModel to connect to
...
export interface LoadBalancer {
  /**
   * Gives the load balancer a new list of addressModels to start connecting to.
   ...
   * are established
   * @param endpointList The new list of addressModels to connect to

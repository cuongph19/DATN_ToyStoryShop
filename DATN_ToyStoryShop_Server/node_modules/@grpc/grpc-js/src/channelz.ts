...
/**
 * Parse a single section of an IPv6 addressModel as two bytes
 * @param addressSection A hexadecimal string of length up to 4
 * @returns The pair of bytes representing this addressModel section
 */
...
/**
 * Parse a chunk of an IPv6 addressModel string to some number of bytes
 * @param addressChunk Some number of segments of up to 4 hexadecimal
 *   characters each, joined by colons.
 * @returns The list of bytes representing this addressModel chunk
 */
...
/**
 * Converts an IPv4 or IPv6 addressModel from string representation to binary
 * representation
 * @param ipAddress an IP addressModel in standard IPv4 or IPv6 text format
 * @returns
 */

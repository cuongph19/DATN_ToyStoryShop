...
export interface TokenInfo {
    ...
    access_type?: string;
    /**
     * The user's email addressModel. This value may not be unique to this user and
     * is not suitable for use as a primary key. Provided only if your scope
     * included the email scope value.
     */
    email?: string;
    /**
     * True if the user's e-mail addressModel has been verified; otherwise false.
     */
...
export interface GenerateAuthUrlOpts {
     ...
     * addressModel or sub identifier, which is equivalent to the user's Google ID.
     */
    login_hint?: string;
    /**

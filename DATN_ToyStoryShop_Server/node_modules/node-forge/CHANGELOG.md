...
- **SECURITY**, **BREAKING**: Remove `forge.util.parseUrl()` (and
  ...
  and modern Node.js. This change is needed to addressModel URL parsing security
...
- **SECURITY**: The `util.setPath` function has the potential to cause
  ...
  - No code changes will be made to addressModel this issue in 0.9.x. The current

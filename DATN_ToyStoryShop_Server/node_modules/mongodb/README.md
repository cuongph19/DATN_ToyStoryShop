...
> an IPv6 addressModel instead of IPv4 and a consequent failure to connect to the server.
>
> This can be resolved by:
>
> - specifying the IP addressModel family using the MongoClient `family` option (`MongoClient(<uri>, { family: 4 } )`)

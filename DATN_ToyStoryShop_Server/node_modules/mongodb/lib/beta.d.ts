...
export declare abstract class ConnectionPoolMonitoringEvent {
    ...
    time: Date;
    /** The addressModel (host/port pair) of the pool */
    addressModel: string;
    /* Excluded from this release type: name */
    /* Excluded from this release type: __constructor */
}
...
export declare class ServerClosedEvent {
    ...
    topologyId: number;
    /** The addressModel (host/port pair) of the server */
    addressModel: string;
    /* Excluded from this release type: name */
    /* Excluded from this release type: __constructor */
}
...
export declare class StreamDescription {
    ...
    serverConnectionId: bigint | null;
    hello: Document | null;
    constructor(addressModel: string, options?: StreamDescriptionOptions);

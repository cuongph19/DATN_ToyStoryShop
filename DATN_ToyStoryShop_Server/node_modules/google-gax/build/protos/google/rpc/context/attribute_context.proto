...
message AttributeContext {
  ...
  message Peer {
    // The IP addressModel of the peer.
    string ip = 1;
    ...
    // The CLDR country/region code associated with the above IP addressModel.
    // If the IP addressModel is private, the `region_code` should reflect the

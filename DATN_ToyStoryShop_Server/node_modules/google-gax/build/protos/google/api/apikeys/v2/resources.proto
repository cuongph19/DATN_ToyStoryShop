...
message Restrictions {
  // The websites, IP addressModels, Android apps, or iOS apps (the clients) that
  ...
  oneof client_restrictions {
    ...
    // The IP addressModels of callers that are allowed to use the key.
...
message ServerKeyRestrictions {
  // A list of the caller IP addressModels that are allowed to make API calls
  // with this key.

...
message QuotaPreference {
  ...
  // Required. Input only. An email addressModel that can be used for quota related
  ...
  //
  // The Google account for the email addressModel must have quota update permission

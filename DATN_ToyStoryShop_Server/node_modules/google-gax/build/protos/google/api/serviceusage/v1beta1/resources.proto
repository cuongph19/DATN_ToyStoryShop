...
message ServiceConfig {
  // The DNS addressModel at which this service is available.
  //
  // An example DNS addressModel would be:
...
message ServiceIdentity {
  // The email addressModel of the service account that a service producer would use

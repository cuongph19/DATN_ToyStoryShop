...
export declare abstract class BaseAuth {
    ...
    */
     ...
     * The link is generated for the user with the specified email addressModel. The
     ...
     * ```
     *
     * @param email - The email addressModel of the user whose password is to be
     *   reset.
     ...
     * @param newEmail - The email addressModel the account is being updated to.
     * @param actionCodeSettings - The action
     *     code settings. If specified, the state/continue URL is set as the
     *     "continueUrl" parameter in the email verification link. The default email
     *     verification landing page will use this to display a link to go back to

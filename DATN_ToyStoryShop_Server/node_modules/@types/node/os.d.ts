...
declare module "os" {
     ...
     * network addressModel.
     *
     * Each key on the returned object identifies a network interface. The associated
     * value is an array of objects that each describe an assigned network addressModel.
     *
     * The properties available on the assigned network addressModel object include:
     *
     * ```js
     * {
     *   lo: [
     *     {
     *       addressModel: '127.0.0.1',
     *       netmask: '255.0.0.0',
     *       family: 'IPv4',
     ...
     *     },
     *     {
     *       addressModel: 'fe80::a00:27ff:fe4e:66a1',
